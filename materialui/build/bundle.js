...
var AnotherPage = require('./pages/AnotherPage');
// endinject

var menuItems = [
  // inject:menuitems
  { payload: 'home', text: 'Donald Zhong' },
  { payload: 'another', text: 'About Me' },
  // endinject
];
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
    ...
    React.createElement(Route, {name: "another", handler: AnotherPage}), 
    /* endinject */
...
},{"./pages/AnotherPage":250,"./pages/HomePage":251,"material-ui":7,"react":249,"react-router":50,"react-tap-event-plugin":87}],2:[function(require,module,exports){
/*!
...
module.exports = React.createClass({displayName: "exports",
  render: function () {
    return (
      React.createElement("div", {className: "another-page"}, 
        React.createElement("p", null, "Sorry there isnt anything here. ")
  ...
  render: function () {
    return (
      React.createElement("div", {className: "home-page"}, 
        "Hello and welcome to my app. Please take a look at my other pages."
